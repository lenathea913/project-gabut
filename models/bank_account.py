import json
import os
from exceptions import DanaTidakCukup, InvalidAmountError, AccountLockedError
...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        self._account_history.append(f"Deposit: Rp.{amount:,.0f}")
    ...
    def withdraw(self, amount):
        ...
        self._balance -= amount
        self._account_history.append(f"Penarikan: Rp.{amount:,.0f}")
        self.save_account_data()
    ...
    def transfer(self, amount, target_account):
        ...
        self._account_history.append(
            f"Transfer: Rp.{amount:,.0f} ke {target_account.get_account_holder()}"
        )
        self.save_account_data()
